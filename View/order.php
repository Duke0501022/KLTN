...
if (isset($_POST) && isset($_POST["total"]) && isset($_POST["id_datlich"])) {

    $order_total = $_POST["total"];
    $id_datlich = $_POST["id_datlich"];
    if (is_numeric($order_total) && is_numeric($id_datlich)) {

        // Cố định tên cho đơn hàng
        $name = "Đặt lịch tư vấn";

        // Tao query SQL insert dữ liệu đơn hàng vào bảng tb_orders
        $sql = "INSERT INTO tb_orders (total, name, id_datlich) VALUES ('{$order_total}', '{$name}', '{$id_datlich}')";
            ...
            <?php } else { ?>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 bg-light border-top">
                        ...
                        <p><b>Ngày tạo:</b> <?= date('d/m/Y H:i:s', strtotime($order_details->created_at)); ?></p>
