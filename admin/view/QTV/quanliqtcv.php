...
if (isset($_GET['search_query1'])) {
  ...
  $table = $p->search_qtchuyenvien($search_query); // Ensure the search function is correctly defined
} else {
  $table = $p->get_qtcv();
}
?>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Quản lý quản trị chuyên viên</li>
            </ol>
          </div>
        </div>
      </div>
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Danh sách thông tin quản trị chuyên viên</h3> | <a href="?addqtcv">Thêm quản trị chuyên viên mới</a>
                <div class="card-tools">
                  <form class="search-form" action="index.php" method="GET">
                    <input type="hidden" name="qlqtcv" value="quantrichuyenvien">
              ...
              <div class="card-body table-responsive p-0">
                <table class="table table-hover text-nowrap">
                  <thead>
                    <tr>
                      <th>STT</th>
                      <th>Mã Quản Trị Chuyên Viên</th>
                      <th>Tên Quản Trị Chuyên Viên</th>
                      <th>Số điện thoại</th>
                  ...
                  <tbody>
                    ...
                    if ($table) {
                      ...
                      while ($row = mysqli_fetch_assoc($table)) {
                        ...
                        echo "<td><a href='?updateqtcv&&idQTCV=" . $row['idQTCV'] . "'><i class='fa fa-pen' aria-hidden='true'></i></a> | <a href='?delqtcv&&idQTCV=" . $row['idQTCV'] . "&&username=" . $row['username'] . "' onclick='return confirm_delete();'><i class='fa fa-trash' aria-hidden='true'></i></a></td>";
                        echo "</tr>";
                      }
                    }
                    ?>
