...
<style>
 ...
 <div class="content-wrapper">
    ...
    <div class="container-fluid">
      <div class="row justify-content-center">
        <div class="col-lg-10"> <!-- Changed from col-md-8 to col-lg-10 -->
          <div class="card">
            <div class="card-body">
              <h3 style="text-align:center">Thêm Quản Trị Giáo Viên</h3>
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="tenkh" name="tenkh" placeholder="Nhập Tên Quản Trị Giáo Viên" value="<?php echo isset($_POST['tenkh']) ? htmlspecialchars($_POST['tenkh']) : ''; ?>" required>
    ...
    <div class="form-group text-center">
        <button type="submit" class="btn btn-primary" name="submit">Thêm Quản Trị Giáo Viên</button>
  ...
  <?php
    ...
    if (!empty($errors)) {
        ...
        if (move_uploaded_file($hinhAnh_tmp, $uploads_dir.$hinhAnh)) {
            $nvpp = new cQTV();
            if (!empty($username)) {
                $insert = $nvpp->add_QTGV($hoTen, $soDienThoai, $email, $hinhAnh,$gioiTinh,$username);
                if ($insert == 1) {
