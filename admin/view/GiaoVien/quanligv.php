<?php 
    ...
    if (isset($_GET['search_query1'])) {
        ...
        $table = $p->search_giaovien($search_query); // Ensure the search function is correctly defined
    } else {
        $table = $p->getAllGV();
    }
?>
        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">Danh sách thông tin giáo viên</h3> | <a href="?addgv">Thêm giáo viên mới</a>
                ...
                <?php
                  if ($table) {
                    ...
                    while ($row = mysqli_fetch_assoc($table)) {
                      ...
                      echo "<td><a href='?updategv&&idGiaoVien=" . $row['idGiaoVien'] . "'><i class='fa fa-pen' aria-hidden='true'></i></a> | <a href='?delgv&&idGiaoVien=" . $row['idGiaoVien'] . "&&username=" . $row['username'] . "' onclick='return confirm_delete();'><i class='fa fa-trash' aria-hidden='true'></i></a></td>";
                      echo "</tr>";
                    }
                  }
                  ?>
  ...
  function showDetails(record) {
    ...
    const content = `
        <div class="detail-row">
            <div class="detail-label">Tên Giáo Viên:</div>
