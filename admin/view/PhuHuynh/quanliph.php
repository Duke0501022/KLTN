...
if (isset($_GET['search_query'])) {
    ...
    $table = $p->search_KHDN($search_query); // Ensure the search function is correctly defined
} else {
    $table = $p->select_KHDN();
}
?>
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                ...
                <div class="card-tools">
                  <form class="search-form" action="index.php" method="GET">
                    <input type="hidden" name="qlkhdn" value="">
              ...
              <div class="card-body table-responsive p-0">
                <table id="phuhuynhTable" class="table table-hover text-nowrap">
                  <thead>
                    <tr>
                      <th>STT</th>
                      <th>Tên Phụ Huynh</th>
                  ...
                  <tbody>
                    ...
                    if ($table) {
                      ...
                      while ($row = mysqli_fetch_assoc($table)) {
                        ...
                        echo "<td><a href='?updatekh&&MaKH=" . $row['idPhuHuynh'] . "'><i class='fa fa-pen' aria-hidden='true'></i></a> | <a href='?delkh&&idPhuHuynh=" . $row['idPhuHuynh'] . "&&username=" . $row['username'] . "' onclick='return confirm_delete();'><i class='fa fa-trash' aria-hidden='true'></i></a></td>";
                    
                        "<td><span style='display:none;'>" . $row['soDienThoai'] . "</span></td>";
                        "<td><span style='display:none;'>" . $row['ngaySinh'] . "</span></td>";
                        "<td><span style='display:none;'>" . $row['diaChi'] . "</span></td>";
                        echo "</tr>";
                      }
                    }
                    ?>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Chi tiết phụ huynh</h5>
  ...
  function showDetails(record) {
    ...
    const content = `
        <div class="detail-row">
            <div class="detail-label">Tên Phụ Huynh:</div>
